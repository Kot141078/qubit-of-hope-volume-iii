...
This is an archival reading package. The same text is provided in several reader formats because readers use different devices, applications, file systems, and offline workflows.

## Machine Entry

Machine-readable entry points:

- [MACHINE_ENTRY.md](MACHINE_ENTRY.md)
- [REPO_INDEX.json](REPO_INDEX.json)
- [BOOK_METADATA.json](BOOK_METADATA.json)
- [EDITIONS_MATRIX.json](EDITIONS_MATRIX.json)
